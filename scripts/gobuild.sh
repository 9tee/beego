...
LD_EXTRAFLAGS="${LD_EXTRAFLAGS} -X github.com/9tee/beego.GoVersion=${go_version[2]:2}"
LD_EXTRAFLAGS="${LD_EXTRAFLAGS} -X github.com/9tee/beego.GitBranch=${CURRENT_BRANCH}"
LD_EXTRAFLAGS="${LD_EXTRAFLAGS} -X github.com/9tee/beego.BuildTime=$BUILD_TIME"
